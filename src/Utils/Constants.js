...
export const socialComponentItems= [
    {title: "Medium", link: "https://medium.com/@ashikthulungrai7", logo: MediumLogo, logoText: MediumText, color: 'purple', dataComponent: <MediumPageComponent />},
    {title: "Github", link: "https://github.com/ashikrai", logo: GitHubLogo, logoText: GitHubText, color: 'green', dataComponent: <MediumPageComponent />},
    {title: "LinkedIn", link: "https://www.linkedin.com/in/ashik-rai/", logo: LinkedInLogo, logoText: LinkedInText, color: 'blue', dataComponent: <MediumPageComponent />},
    {title: "Pinterest", link: "https://in.pinterest.com/ashikthulungrai7/", logo: PinterestLogo, logoText: PinterestText, color: 'pink', dataComponent: <MediumPageComponent />},
]
